	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.id("textarea")).sendKeys("madipakkam chennai-91");
		 ...
		 gender.click();
			  ...
			  WebElement country = driver.findElement(By.id("country")); Select slt = new
			  Select(country); slt.selectByIndex(9);
			 

				/*
				 * driver.findElement(By.xpath("//button[contains(text(),'New Browser Window')]"
				 * )).click(); ArrayList <String> wh = new
				 * ArrayList<>(driver.getWindowHandles()); driver.switchTo().window(wh.get(1));
				 * driver.getTitle();
				 */
